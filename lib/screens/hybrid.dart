...
import 'package:e_cars_ui/screens/cng.dart';
import 'package:flutter/material.dart';

import 'hybrid_car_screen.dart';

class Hybrid extends StatefulWidget {
  const Hybrid({Key? key}) : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (_) => const HybridCarsScreen(),
          ),
        );
      },
      child: SizedBox(
    ...
    return SizedBox(
      ...
      child: Row(
        children: [
          ...
          customSwitchItem(size, green, "Hybrid"),
          GestureDetector(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (_) => Cng()));
              },
              child: customSwitchItem(size, black, "CNG")),
